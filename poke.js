...
for(let publisher in publisher){
  let publishDiv = document.querySelector(".publishers");
  publishDiv.insertAdjacentHTML("afterbegin", `<div className="publish-container">
...
videoGames
  ...
  .forEach((game) => document.querySelector("game"))
...
/* async function getData(poke) {
  try {
    ...
    if (response.status != 200) {
      ...
      //makes the response into ison data we can use
